...
{{ include "common.images.image" (dict "imageRoot" .Values.global.postgresql.image "global" .Values.global "chart" .Chart) }}
{{- end -}}
...
{{- $global := dict "imagePullSecrets" .Values.global.pullsecrets -}}
{{ include "common.images.pullSecrets" (dict
  "images" (list .Values.global.postgresql.image)
  "global" $global
) }}
{{- end -}}
